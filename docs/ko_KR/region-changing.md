...
!!! danger "Important" This process will unlink your NNID from the system because it will no longer be compatible with your NNID. NNIDs are locked to the region of your device that created them and cannot be transferred between regions.
...
!!! tip "No tickets?" If script found no user tickets told you to skip this section, then skip this section
