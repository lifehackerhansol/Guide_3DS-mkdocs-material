...
!!! tip "" If you have hacked your 3DS in the past, or you purchased your 3DS second-hand, it is possible that your console already has custom firmware. You should [check for CFW](../extras/checking-for-cfw.md) before proceeding.
...
!!! tip "" ![System Version](/images/screenshots/system-version.png)

!!! danger "Important" Before starting, you may want to check your SD card for errors using [H2testw (Windows)](../extras/h2testw-(windows).md), [F3 (Linux)](../extras/f3-(linux).md), or [F3XSwift (Mac)](../extras/f3xswift-(mac).md)!
